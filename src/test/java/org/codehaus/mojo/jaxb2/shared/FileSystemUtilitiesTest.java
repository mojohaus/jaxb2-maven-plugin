...
public class FileSystemUtilitiesTest
{
    ...
    public void validateSimplifiedFileExistenceRetrieval()
    {
        ...
        final File nonExistentRelativeFile = FileSystemUtilities.getExistingFile( aNonExistentRelativePath,
                fsUtilitiesDirectory );
    ...
    public void validateFilteredDirectoryListingUsingExcludeFilters()
    {
        ...
        // Act & Assert
        Assert.assertEquals( 0, FileSystemUtilities.listFiles( exclusionDir, noFiles, log ).size() );
    ...
    public void validateResolvingFilesAndRemovingExclusions()
    {
        ...
        final List<Filter<File>> matchNonexistentFiles = PatternFileFilter.createIncludeFilterList( log,
                "\\.nonexistent" );
        ...
        final List<String> canonicalPathsForExplicitlyAddedFiles = getRelativeCanonicalPaths( noFilterFiles,
                depsPropertiesFile.getParentFile() );
        Assert.assertTrue( canonicalPathsForExplicitlyAddedFiles.contains( "/deps1.properties" ) );

        final List<String> canonicalPathsForNoTextFiles = getRelativeCanonicalPaths( noTextFiles,
                depsPropertiesFile.getParentFile() );
        ...
        final List<String> canonicalPathsForNoXmlFiles = getRelativeCanonicalPaths( noXmlFiles,
                depsPropertiesFile.getParentFile() );
        ...
        final List<String> canonicalPathsForAllFiles = getRelativeCanonicalPaths( allFiles,
                depsPropertiesFile.getParentFile() );
    ...
    public void validateFilteringFiles()
    {
        ...
        // Act
        final List<File> result = FileSystemUtilities.filterFiles( basedir, null, "filefilter/exclusion", log,
                "testFiles", excludeTextFiles );
    ...
    public void validateFilterFilesWithSuppliedSourcesAndExcludePatterns()
    {
        ...
        // Assemble
        final BufferingLog log = new BufferingLog( BufferingLog.LogLevel.DEBUG );
        final List<String> sources = Arrays.asList( "filefilter/exclusion/AnXmlFile.xml",
                "filefilter/exclusion/TextFile.txt" );
        final URL sharedDirUrl = getClass().getClassLoader().getResource( "testdata/shared" );
        final File basedir = new File( sharedDirUrl.getPath() );
        final List<Filter<File>> excludeTextFiles = PatternFileFilter.createIncludeFilterList( log, "\\.txt" );

        // Act
        final List<File> result = FileSystemUtilities.filterFiles( basedir, sources, "filefilter/exclusion", log,
                "testFiles", excludeTextFiles );
    ...
    public void validateGettingFileForClassURL()
    {
        ...
        // Assemble
        final URL streamingDhURL = PropertyResources.class.getProtectionDomain().getCodeSource().getLocation();
    ...
    public void validateRelativizingPaths() throws Exception
    {
        ...
        for ( Map.Entry<String, String> current : parentDir2Expected.entrySet() )
        {
            ...
            final String expectedMessage = "Given parent dir [" + current.getKey() + "], expected [" + current.getValue() + "] from [" + path + "] but found: ";
