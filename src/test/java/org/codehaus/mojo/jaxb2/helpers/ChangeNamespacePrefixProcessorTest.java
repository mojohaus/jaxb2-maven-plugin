...
public class ChangeNamespacePrefixProcessorTest
{
    ...
    public void validateAcceptCriteria()
    {
        ...
        // Act
        final Document document = SchemagenHelper.parseXmlStream( new StringReader( xmlStream ) );
        SchemagenHelper.process( document.getFirstChild(), true, debugNodeProcessor );
