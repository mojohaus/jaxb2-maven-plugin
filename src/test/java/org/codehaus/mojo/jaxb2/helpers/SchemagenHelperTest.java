 ...
 */
public class SchemagenHelperTest
{
    ...
    public void validateProcessingNodes()
    {
        ...
        // Act
        final Document processedDocument = SchemagenHelper.parseXmlStream( new StringReader( originalXml ) );
        SchemagenHelper.process( processedDocument.getFirstChild(), true, changeNamespacePrefixProcessor );

        // Assert
        final Document expectedDocument = SchemagenHelper.parseXmlStream( new StringReader( changedXml ) );
        ...
        throws MojoExecutionException
    {
        ...
        final Map<String, SimpleNamespaceResolver> fileNameToResolverMap =
            SchemagenHelper.getFileNameToResolverMap( directory );
