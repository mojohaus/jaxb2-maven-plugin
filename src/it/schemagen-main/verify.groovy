...
/*
[INFO]   The post-build script did not succeed. Missing required file
[/Users/lenjor/Development/Projects/Mojohaus/jaxb2-maven-plugin/target/it/schemagen-main/
target/generated-resources/schemagen/META-INF/sun-jaxb.episode]. Expression: (aFile.exists() && aFile.isFile())
*/
...
validateExistingFile(new File(classesDir, 'META-INF/JAXB/episode_schemagen.xjb'), 2);
